...
//            Toast.makeText(this, "不支援NFC感應功能", Toast.LENGTH_SHORT).show();
            Toast.makeText(this,"There is no support of NFC Moudle", Toast.LENGTH_SHORT).show();
            this.finish();
            return;
        }
    ...
    protected void onResume()
    {
        ...
        if (NfcAdapter.ACTION_NDEF_DISCOVERED.equals(getIntent().getAction())) {
            ...
            startContentShowActivity(payload);
    ...
    private void startContentShowActivity(byte[] payload)
    {
        Intent intent = new Intent();
        intent.setClass(this, TabContentActivity.class);

        String strCode = new String(payload);
        NfcLog.v(TAG, "payload is " + strCode);
